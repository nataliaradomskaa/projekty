...
<body>
    <header>
        ...
        <nav>
            ...
            <div class="nav2">
                <ul class="menu1">
                    <li><a href="skleppo.php">Produkty</a></li>
                    <li><a href="karnetypo.php">Karnety</a></li>
                </ul>
            </div>
        </nav>
    </header>
        ...
        <table class="table table-bordered">
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="text-center" width="10%" scope="col">Zakup</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    <tr class="wysrodkuj">
                        ...
                        <td>
                            <form action='kupowanie.php' method="post">
                                <input type="hidden" name="id_karnetu" value="<?php echo $wiersz['id_karnetu']; ?>">
                                <input type="submit" name="kupkarnet" value="Kup">
                            </form>
                        </td>
