...
if (!isset($_SESSION['koszyk'])) {
    $_SESSION['koszyk'] = array(); // zmienna tablicowa, ktora przechowuje id dodanych produktow do koszyka
}
...
<body>
            ...
            <tbody>
                ...
                <?php while ($wiersz = mysqli_fetch_array($sql)) { ?>
                    ...
                    <tr class="w-25">
                        ...
                        <td>
                            <span><a href="dodajdokoszyka.php?id_produktu=<?php echo $wiersz['id_produktu']; ?>" class="btn btn-primary btn-sm">Dodaj</a></span>
                        </td>

                        <!-- <span><a href="dodajdokoszyka.php?id_produktu=<?php echo $wiersz['id_produktu']; ?>" class="btn btn-primary btn-sm glyphicon glyphicon-plus"></span></a> -->
    ...
    <div class="koszyk"><a href="koszyk.php">Przejdź do koszyka</a></div>
    <br /><br /><br />
