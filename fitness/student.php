            ...
            <div class="formularz">
                ...
                <div class="wprowadz-dane">
                    <form method="post" action="weryfikacja.php">
                        ...
                        <div class="form">
                            <label class="label">Numer albumu studenta: </label>
                            <input type="text" name="nr_albumu" class="input" placeholder="Wprowadź numer albumu" />
                        </div>
                        <?php
                        if (isset($_SESSION['zweryfikowany'])) {
                            header('Location: historiazamowien.php');
                        }
                        ?>
